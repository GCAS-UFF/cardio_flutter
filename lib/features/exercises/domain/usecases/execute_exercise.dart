...
class ExecuteExercise extends UseCase<Exercise, Params> {
  final ExerciseRepository repository;

  ExecuteExercise(this.repository);
  @override
  Future<Either<Failure, Exercise>> call(Params params) async {
    return await repository.executeExercise(params.exercise, params.patient);
  }
}
