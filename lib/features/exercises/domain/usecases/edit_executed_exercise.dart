...
class EditExecutedExercise extends UseCase<Exercise, Params> {
  final ExerciseRepository repository;

  EditExecutedExercise(this.repository);
  @override
  Future<Either<Failure, Exercise>> call(Params params) async {
    return await repository.editExecutedExercise(params.exercise, params.patient);
  }
}
