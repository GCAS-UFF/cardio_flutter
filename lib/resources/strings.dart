class Strings {
  ...
  static const name_title = "Nome";
  static const cpf_title = "CPF";
  static const cpf_hint = "000.000.000-00";
  static const register = "Registro Regional";
  ...
  // Email validator
  static const email_format_error_message = "Você digitou o email errado";
...
//Medication Page
  ...
  static const help_answer4 = "Nesta tela serão exibidas todas as consultas marcadas (cor Azul) e os dados das consultas que já passaram"
      " (Cor Laranja); ao clicar no item azul, será possivel preenchê-lo, e ao salvar surgirá um novo item Laranja. Caso tenha ocorrido algum erro"
      " durante o preenchimento, não se preocupe, pois é possível editá-lo posteriormente; ao clicar no item laranja, aparecerá um menu com 2 opções"
      ": \"Editar\", para ajustar as informações do item realizado, e \"Excluir\", caso deseje excluir um dos itens realizados. Para cada nova"
  ...
  static const help_answer6 = "Nesta tela, você encontrará informações sobre a Insuficiência Cardíaca.";
  static const help_answer7 = "Nesta tela, você encontrará informações sobre a concepção do aplicativo e seus colaboradores.";
  ...
  static const orientation_answer2 = "Os sintomas podem aparecer aos poucos quando se realiza alguma atividade, ou até mesmo, em repouso.\n"
      "Exemplo de sintomas:\n"
      "1. Falta de ar\n2. Tosse\n3. Náusea \n4. Palpitações \n5. Ganho de peso"
      "\n6. Inchaço nas pernas, pés ou tornozelos\n7. Tontura\n8. Cansaço \n9. Confusão mental";
  static const orientation_answer1 = "É a dificuldade do coração em se encher de sangue corretamente e bombeá-lo de "
      "forma suficiente para abastecer as necessidades do corpo ";
  static const orientation_answer3_1 = "1. Mantenha alimentação saudável, com pouca gordura, pouco sal e rica em frutas, legumes e verduras\n\n2.";
  static const orientation_answer3_2 = "os alimentos embutidos, comidas congeladas (industrializadas), temperos prontos, alimentos em conservas e os "
  ...
  static const orientation_answer6 = "- Escolha um horário e crie o hábito de se pesar com roupas leves, isto deve ser feito diariamente."
      "\n- O ganho de peso em excesso pode indicar Insuficiência Cardíaca descompensada.";
  static const orientation_answer7 = "- O cigarro contém substâncias tóxicas que provocam aumento do trabalho do coração."
  ...
  static const orientation_answer8 = "- Faça uma lista com todas as suas razões para parar de fumar"
  ...
  static const orientation_answer9 = "- Tome os medicamentos conforme orientação e prescrição de seu médico.  "
  ...
  static const orientation_answer10 = "Participe das campanhas de vacinação contra influenza (gripe) e pneumococo (pneumonia). ";
  static const orientation_answer11 = "É muito importante comparecer em todas as consultas, para realizar um acompanhamento adequado "
